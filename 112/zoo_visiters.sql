...
CREATE TABLE `visiters` (
  ...
  PRIMARY KEY (`id`),
  KEY `visites_usr_idx` (`user_id`),
  CONSTRAINT `visites_usr` FOREIGN KEY (`user_id`) REFERENCES `user` (`id_user`)
...
LOCK TABLES `visiters` WRITE;
/*!40000 ALTER TABLE `visiters` DISABLE KEYS */;
INSERT INTO `visiters` VALUES (1,1,'2025-12-20'),(2,2,'2025-12-20');
...
-- Dump completed on 2023-09-29 12:44:02
